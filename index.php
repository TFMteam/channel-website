				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx2-heading'>
							<p>
								 Это наш сайт, здесь мы чуть чуть разместили информации, не забывайте что вы можете заказать у нас сайт, как и где? Узнаете ниже.
							</p>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 У нас есть свой дискорд сервер, где мы оповещаем о планах на канал, каких то новостях и так далее раньше всего. Также там вы можете найти себе друзей.
								</p>
							</div>
							<a href="https://discord.gg/XjVcMWm7u9" target="_blank">
							<div class="discord-btn-button">
								<div class="discord-ico-button">
								</div>
								<div class="discord-tx1-button">
									<span>Подключится к пати</span>
								</div>
							</div>
							</a>
						</div>
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							...
							<div class="github-tx2-mantra darkmode-txt">
								<p>
									 Помимо всего прочего, мы снимаем сериал "Конец связи", и не отказались бы от людей которые бы приняли участие в создании проекта. Если вы хотите попасть в проект, переходите по ссылке и обращайтесь к нам.
								</p>
							</div>
							<a href="https://vk.com/websitecustom2" target="_blank">
					...
					<div class="patreon-con-mantra">
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							...
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
									 Можете помочь или же поддержать нас, наш канал и наши проекты. Вы можете заказать у нас сайт, или же если не жалко просто отправить немного зеленых. Всем спасибо кто нам помогает!
								</p>
							</div>
							<a href="https://www.donationalerts.com/r/team_friends_2" target="_blank">
