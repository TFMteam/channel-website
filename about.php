					...
					<div class='container-con-block darkmode-block'>
						<div class='container-con-wrapper'>
							...
							<div class='container-tx2-block darkmode-txt'>
								<p>
									 Создать канал нам пришло в голову примерно в январе/феврале 2021 года. Мы долго думали как назвать канал? Какой будет главный значок канала так скажем. Остановились на TFM - team friends minecraft, а значком стал троллфейс на желтом фоне. <br>
									<br>
									 Изначально мы не планировали снимать различные игры, мы хотели снимать сериалы. Но как оказалось снимать сериалы не просто и поэтому решили снимать игры.
								</p>
							</div>
						</div>
					</div>
				...
				<div class='splitter-txt-wrapper'>
					<div class='container-con-block darkmode-block'>
						<div class='container-con-wrapper'>
							...
							<div class='container-tx2-block darkmode-txt'>
								<p>
									 Изначально нас было четверо, но сейчас по определенным причинам нас лишь двое, челик и хомяк. Поэтому поскольку мы вдвоем нам сложновато делать какие то масштабные ролики, например как сериал. <br>
									<br>
									 В основном монтажом роликов занимается челик а хомяк пишет сценарий к сериалу и в тоже время тоже учится монтировать.
								</p>
							</div>
						</div>
					</div>
				...
				<div class='splitter-txt-wrapper'>
					<div class='container-con-block darkmode-block'>
						<div class='container-con-wrapper'>
							...
							<div class='container-tx2-block darkmode-txt'>
								<p>
									 Пока что мы занимаемся сериалом и программированием. Опять же вы можете заказать у нас сайт только имейте ввиду что мы школьники нам по 12 лет и мы не сможем сделать вам идеальнейший сайт, однако мы будем стараться делать качественно. <br>
									<br>
									 Планов как таковых пока что нету, ибо мы заняты 2 школоми, каналом, програмированием а также зарабатываем на свою мечту.
								</p>
							</div>
						</div>
					</div>
